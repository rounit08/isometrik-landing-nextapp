...
const AIbotSection = () => {
    return (
        <div className="flex flex-col items-center p-1 md:p-10">
            <span className="text-center font-bold text-3xl w-10/12 md:w-1/2 2xl:w-3/2 2xl:text-[90px] 2xl:leading-[80px]">Produce AI bots for various roles across your business</span>
