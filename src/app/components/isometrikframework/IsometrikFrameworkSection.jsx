    ...
    return (
        <div className="flex flex-col items-center p-5 gap-10 md:gap-0">
            <div className="flex flex-col items-center p-2 md:p-10 gap-4">
                <span className="text-center font-bold text-3xl  md:w-1/2">Isometrik Agent Framework abstracts the complexity</span>
                <div className="hidden md:flex flex-col text-center text-base font-normal">
            ...
            <div>
                <Image src={IsometrikImage} alt="isometrik image" height={900} width={1000}/>
            </div>
